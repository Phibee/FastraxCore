        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentAccessModuleId = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessModules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccessModules_AccessModules_ParentAccessModuleId",
                        column: x => x.ParentAccessModuleId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessModules_ParentAccessModuleId",
                schema: "settings",
                table: "AccessModules",
                column: "ParentAccessModuleId");
